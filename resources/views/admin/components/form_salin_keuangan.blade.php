    ...
    <div class="modal-body">
        ...
        <div id="modal-view">
            <div style="line-height: 1">
                <div class="my-2">
                    <div class="text-gray-400 text-small">Sesi Lama<small class="text-danger">*</small></div>
                    <div>
                        <select name="sesi_lama" id="sesi_lama" class="form-control">
                ...
                <div class="my-2">
                    <div class="text-gray-400 text-small">Sesi Baru<small class="text-danger">*</small></div>
                    <div>
                        <select name="sesi_baru" id="sesi_baru" class="form-control">
                            @foreach ($sesi as $item)
                                <option value="{{ $item->sesi_kode }}" {{ $item->sesi_status ? 'selected' : '' }}>{{ $item->sesi_nama.' - '.$item->sesi_tahun }}</option>
                            @endforeach
                        </select>
            ...
            <div class="">
                <button type="submit" class="btn btn-block btn-blue-500 px-3 rounded btn-save">Salin</button>
