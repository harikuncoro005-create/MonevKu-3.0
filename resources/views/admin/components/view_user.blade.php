...
<?php } else {
    foreach ($records as $index => $item) { ?>
        <tr style="line-height: 1;">
            ...
            <td class="text-center"><div class="px-2 py-1 text-white rounded" style="background-color: {{ $level[$item->admin_level]['color'] }}; font-size: 0.65rem">{{ $level[$item->admin_level]['nama'] }}</div></td>
