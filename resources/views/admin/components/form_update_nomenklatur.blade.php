...
<form id="form-add" autocomplete="off">
    <div class="modal-body">
        ...
        <div style="line-height: 1">
            <input type="hidden" id="nomenklatur_id" name="nomenklatur_id" class="form-control" value="{{ $result->nomenklatur_id }}">
            <div class="my-2">
                <div class="text-gray-400 text-small">Kode <small class="text-danger">*</small></div>
                <div>
                    <input type="text" id="kode" name="kode" class="form-control" value="{{ $result->nomenklatur_kode }}">
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Nama <small class="text-danger">*</small></div>
                <div>
                    <input type="text" id="nama" name="nama" class="form-control" value="{{ $result->nomenklatur_nama }}">
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Indikator Keluaran</div>
                <div>
                    <input type="text" id="indikator" name="indikator" class="form-control" value="{{ $result->nomenklatur_indikator_keluaran }}">
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Satuan</div>
                <div>
                    <input type="text" id="satuan" name="satuan" class="form-control" value="{{ $result->nomenklatur_satuan_keluaran }}">
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Tahun <small class="text-danger">*</small></div>
                <div>
                    <input type="text" id="tahun" name="tahun" class="form-control" value="{{ $result->nomenklatur_tahun }}">
                </div>
            </div>
        </div>
        <br>
