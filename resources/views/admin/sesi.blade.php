        ...
        <table class="table table-hover table-bordered">
                <thead style="font-weight: 500; font-size: 0.9rem; line-height: 1rem; background-color: #f9fafb">
                    <tr class="text-center">
                        <td style="vertical-align: middle; width: 1rem">NO</td>
                        <td style="vertical-align: middle;">NAMA</td>
                        <td style="vertical-align: middle; width: 10rem;">KODE</td>
                        <td style="vertical-align: middle; width: 10rem;">Tanggal</td>
