<form id="form-add" autocomplete="off">
    <div class="modal-body">
        ...
        <div style="line-height: 1">
            ...
            <div class="my-2">
                <div class="text-gray-400 text-small">{{ $item }} <small class="text-danger">*</small></div>
                <div>
                    <input type="number" id="bulan_{{ $index }}" name="bulan_{{ $index }}" class="form-control" value="0">
                </div>
            </div>
            @endforeach --}}
        </div>
