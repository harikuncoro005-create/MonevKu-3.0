                            ...
                            <?php if(count($akun_5) > 0) {
                                ...
                                <?php if(count($akun_6) > 0) {
                                    ...
                                    <tr style="line-height: 1;" class="small">
                                        ...
                                        <td class="text-center">
                                            {{ array_key_exists($keuangan->keyBy('keuangan_subkegiatan_kode')[$val_6['akun_kode']]->keuangan_subkegiatan_kode, $fisik_target_bulan) ? $fisik_target_bulan[$keuangan->keyBy('keuangan_subkegiatan_kode')[$val_6['akun_kode']]->keuangan_subkegiatan_kode] : 0 }}
                                        </td>
