    ...
    <div class="modal-body">
        ...
        <div style="line-height: 1">
            ...
            <div class="my-2">
                ...
                <div>
                    <select id="tahapan" name="tahapan" class="form-control">
                        <option value="" hidden>Pilih Tahapan</option>
            ...
            <div class="my-2">
                ...
                <div>
                    <input type="number" id="nomor" name="nomor" class="form-control"y>
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Aktivitas <small class="text-danger">*</small></div>
                <div>
                    <textarea id="aktivitas" name="aktivitas" class="form-control"y></textarea>
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Acuan <small class="text-danger">*</small></div>
                <div>
                    <input type="number" id="acuan" name="acuan" class="form-control"y>
                </div>
            </div>
            <hr>
            <div class="my-2">
                <div class="row">
                    <div class="col-6">
                        @for ($i=1; $i <= 6; $i++)
                            ...
                            <div>
                                <input type="number" id="bulan_{{ $i}}" name="bulan_{{ $i }}" class="form-control" value="0">
                            </div>
                        @endfor
                    </div>
                    <div class="col-6">
