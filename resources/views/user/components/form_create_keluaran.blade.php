<form id="form-add" autocomplete="off">
    <div class="modal-body">
        ...
        <div style="line-height: 1">
            <input type="hidden" class="form-control" name="subkegiatan" value="{{ $nomenklatur->nomenklatur_kode }}">
            ...
            {{-- <div class="my-2">
                <div class="text-gray-400 text-small">Kode </div>
                <div>
                    <input type="text" name="kode" class="form-control" value="1" readonly>
                </div>
            </div> --}}
            <hr>
            @if ($kode == 1)
            ...
            @else
                <div class="my-2">
                    <div class="text-gray-400 text-small">Keluaran <small class="text-danger">*</small></div>
                    <div>
                        <textarea id="keluaran" name="keluaran" class="form-control"></textarea>
                    </div>
                </div>
                <div class="my-2">
                <div class="text-gray-400 text-small">Target <small class="text-danger">*</small></div>
