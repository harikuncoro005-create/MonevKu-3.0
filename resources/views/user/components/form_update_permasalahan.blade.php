<form id="form-add" autocomplete="off">
    <div class="modal-body">
        ...
        <div style="line-height: 1">
            <input type="hidden" class="form-control" name="id" value="{{ $permasalahan->permasalahan_id }}">
            <div class="my-2">
                <div class="text-gray-400 text-small">Permasalahan <small class="text-danger">*</small></div>
                <div>
                    <textarea id="permasalahan" name="permasalahan" class="form-control">{!! json_decode($permasalahan->permasalahan_deskripsi) !!}</textarea>
                </div>
            </div>
            <div class="my-2">
                <div class="text-gray-400 text-small">Tindak Lanjut <small class="text-danger">*</small></div>
                <div>
                    <textarea id="tindaklanjut" name="tindaklanjut" class="form-control">{!! json_decode($permasalahan->permasalahan_tindaklanjut) !!}</textarea>
                </div>
            </div>
        </div>
        <br>
