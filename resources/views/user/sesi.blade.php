...
<div class="card border-0 shadow-sm rounded-lg overflow-hidden my-3" style="background: #ffffff; border-left: 4px solid #4e73df;">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <span class="text-dark font-weight-bold" style="font-size: 1.1rem;">
                        {{ session('session_kode')->sesi_nama ?? 'Sesi Belum Dipilih' }}
                    </span>
                </div>
            </div>
...
{{-- <div class="bg-white rounded px-4 py-3 my-3 shadow-sm">
    <div class="card-body alert-warning rounded">
        <div class="d-flex justify-content-between align-items-center flex-row" style="column-gap: 0.5rem;">
            <div>{{ session('session_kode')->sesi_nama }}</div>
            <div cl>
                <a href="" to="create-sesi" title="Pilih Sesi" class="btn btn-blue-500 btn-add" style="width: 7.5rem" url="{{ $url_form }}">Ganti</a>
            </div>
        </div>
    </div>
</div> --}}
